...
Only repositories listed as in-scope on the [Intigriti program page](https://app.intigriti.com/programs/digitalocean/digitalocean/detail) are eligible for rewards under the bug bounty program. Due to a significant increase in invalid, AI-generated report submissions distracting from valid, impactful reports has led us to keep all our open-source repos out of scope at the current time.
